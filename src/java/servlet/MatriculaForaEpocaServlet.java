...
import controller.MatriculaForaEpocaJpaController;
 ...
 * @author Meldo Maunze
 */
public class MatriculaForaEpocaServlet extends HttpServlet {
     ...
     *
     */
    MatriculaForaEpocaJpaController matriculaForaEpocaController = new MatriculaForaEpocaJpaController(emf);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameterMap().isEmpty()) {
            request.getRequestDispatcher("matricula_fora_da_epoca.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        long anoValue = 0;
        MatriculaForaEpoca matriculaForaEpoca = new MatriculaForaEpoca();
...
// Recupere os parâmetros do formulário
        ...
        tipoPedidoQuery.setParameter("descricao", "Matrícula fora da época");
        ...
        pedido.setJustifiativa(justificativa+"\n Ano de Matricula: "+ano);
        pedido.setTipoPedido(tipoPedido);
        pedido.setEstado(estado);
        
        pedidoController.create(pedido);
        matriculaForaEpoca.setPedido(pedido);
        matriculaForaEpoca.setAnoMatricula(anoValue);
        matriculaForaEpocaController.create(matriculaForaEpoca);
        ...
        response.sendRedirect("matricula_fora_da_epoca.jsp");
    }
