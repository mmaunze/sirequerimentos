...
import controller.TransferenciaCrsJpaController;
 ...
 * @author Meldo Maunze
 */
public class TransferenciaCRServlet extends HttpServlet {
     ...
     *
     */
    TransferenciaCrsJpaController transferenciaCrsJpaController = new TransferenciaCrsJpaController(emf);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameterMap().isEmpty()) {
            request.getRequestDispatcher("transferencia_para_outros_crs.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        TransferenciaCrs transferenciaCrs = new TransferenciaCrs();
...
Curso cursoDestino = cursoController.findCurso(destino);
        ...
        tipoPedidoQuery.setParameter("descricao", "Transferência para outros CRs");
        ...
        pedido.setJustifiativa(justificativa+"\n Cr Destino:"+cursoDestino.getDescricao() );
        pedido.setTipoPedido(tipoPedido);
        pedido.setEstado(estado);
        
        pedidoController.create(pedido);
        transferenciaCrs.setPedido(pedido);
        transferenciaCrs.setDestinoCrs(cursoDestino.getDescricao());
        transferenciaCrsJpaController.create(transferenciaCrs);
        ...
        response.sendRedirect("transferencia_para_outros_crs.jsp");
    }
