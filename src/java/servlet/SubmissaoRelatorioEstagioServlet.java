...
import controller.SubmissaoRelatorioEstagioJpaController;
 ...
 * @author Meldo Maunze
 */
public class SubmissaoRelatorioEstagioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameterMap().isEmpty()) {
            request.getRequestDispatcher("submissao_de_relatorio_de_estagio.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        SubmissaoRelatorioEstagio submissaoRelatorioEstagio = new SubmissaoRelatorioEstagio();
...
// Recupere os parâmetros do formulário
        ...
        if (data != null) {
            ...
            tipoPedidoQuery.setParameter("descricao", "Submissão de Relatório de Estágio");
            ...
            submissaoRelatorioEstagio.setDataSubmissao(dataValue);
            submissaoRelatorioEstagioController.create(submissaoRelatorioEstagio);
            ...
            response.sendRedirect("submissao_de_relatorio_de_estagio.jsp");
        }
    }
