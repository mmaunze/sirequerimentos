...
import controller.CartaoEstudanteJpaController;
...
public class CartaoEstudanteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        CartaoEstudante cartaoEstudante = new CartaoEstudante();
...
// Recupere os parâmetros do formulário
        ...
        tipoPedidoQuery.setParameter("descricao", "Cartão de Estudante 2ª via");
        ...
        pedido.setAssunto("Pedido Cartão de Estudante 2ª via");
        ...
        cartaoEstudante.setPedido(pedido);
        
        cartaoEstudanteController.create(cartaoEstudante);
        ...
        response.sendRedirect("cartao_de_estudante_2_via.jsp");
    }
