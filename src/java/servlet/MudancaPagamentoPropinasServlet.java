...
import controller.MudancaPagamentoPropinasJpaController;
 ...
 * @author Meldo Maunze
 */
public class MudancaPagamentoPropinasServlet extends HttpServlet {
     ...
     *
     */
    MudancaPagamentoPropinasJpaController mudancaPagamentoPropinasController = new MudancaPagamentoPropinasJpaController(emf);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameterMap().isEmpty()) {
            request.getRequestDispatcher("mudanca_de_plano_de_pagamento_de_propinas.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MudancaPagamentoPropinas mudancaPagamentoPropinas = new MudancaPagamentoPropinas();
...
// Recupere os parâmetros do formulário
        ...
        tipoPedidoQuery.setParameter("descricao", "Mudança de Plano de Pagamento de Propinas");
        ...
        pedido.setAssunto("Pedido de "+tipoPedido.getDescricao());
        ...
        mudancaPagamentoPropinas.setPedido(pedido);
        
        mudancaPagamentoPropinasController.create(mudancaPagamentoPropinas);
        ...
        response.sendRedirect("mudanca_de_plano_de_pagamento_de_propinas.jsp");
    }
