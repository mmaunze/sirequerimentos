...
<%@page import="modelo.SubmissaoRelatorioEstagio"%>
<%@page import="controller.SubmissaoRelatorioEstagioJpaController"%>
<%@page import="modelo.SubmissaoMonografias"%>
<%@page import="controller.SubmissaoMonografiasJpaController"%>
...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    SubmissaoRelatorioEstagioJpaController submissaoRelatorioEstagioController = new SubmissaoRelatorioEstagioJpaController(emf);
    SimpleDateFormat dia = new SimpleDateFormat("dd MMMM yyyy ");
    SimpleDateFormat hora = new SimpleDateFormat("HH:MM:SS ");
    List<SubmissaoRelatorioEstagio> pedidos = submissaoRelatorioEstagioController.findSubmissaoRelatorioEstagioEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Submissão de Relatório de Estágio</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/submissao_relatorio_estagio" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Submissão de Relatório de Estágio" readonly="">
                                        <input type="hidden" name="utilizador" value="<%=utilizador.getId()%>">
                                    </div>
                                </div>
                            </div>
                            <div class="j-unit">
                                <label class="j-label">Data de Submissão</label>
                                <div class="j-input">
                                    <label class="j-icon-right" for="data">
                                        <i class="icofont icofont-ui-calendar"></i>
                                    </label>
        ...
        <div class="dt-responsive table-responsive">
            <table id="new-cons" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    <%
                        if (utilizador.getTipoUtilizador().getDescricao().equalsIgnoreCase("administador")) {
                            for (SubmissaoRelatorioEstagio e : pedidos)
