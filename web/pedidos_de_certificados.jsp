...
<%@page import="modelo.PedidosCertificados"%>
<%@page import="controller.PedidosCertificadosJpaController"%>
...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    PedidosCertificadosJpaController pedidosCertificadosController = new PedidosCertificadosJpaController(emf);
    SimpleDateFormat dia = new SimpleDateFormat("dd MMMM yyyy ");
    SimpleDateFormat hora = new SimpleDateFormat("HH:MM:SS ");
    List<PedidosCertificados> pedidos = pedidosCertificadosController.findPedidosCertificadosEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Pedido de Certificados</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/pedido_certificado" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Matricula Fora da Epoca" readonly="">
                                        <input type="hidden" name="utilizador" value="<%=utilizador.getId()%>">
                                    </div>
                                </div>
                            </div>
                            <div class="j-unit">
                                <label class="j-label">Tipo de Certificado</label>
                                <div class="j-input">
                                    <label class="j-icon-right" for="tipoCertificado">
                                        <i class="icofont icofont-ui-user"></i>
                                    </label>
                                    <input type="text" id="tipoCertificado" name="tipoCertificado" value="Certificado" >
                                </div>
                            </div>     
                            <!-- end date -->
                            <div class="j-divider j-gap-bottom-25"></div>
        ...
        <div class="dt-responsive table-responsive">
            <table id="new-cons" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    <%
                        if (utilizador.getTipoUtilizador().getDescricao().equalsIgnoreCase("administador")) {
                            for (PedidosCertificados e : pedidos)
