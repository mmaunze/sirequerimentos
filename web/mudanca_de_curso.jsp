...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    MudancaCursoJpaController equivalenciaController = new MudancaCursoJpaController(emf);
    ...
    List<MudancaCurso> pedidos = equivalenciaController.findMudancaCursoEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Mudança de Curso</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/mudanca_de_curso" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Mudança de Curso" readonly="">
