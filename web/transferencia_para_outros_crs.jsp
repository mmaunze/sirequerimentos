...
<%@page import="modelo.TransferenciaCrs"%>
<%@page import="controller.TransferenciaCrsJpaController"%>
<%@page import="controller.CursoJpaController"%>
<%@page import="modelo.Curso"%>
<%@page import="modelo.MudancaCurso"%>
<%@page import="controller.MudancaCursoJpaController"%>
...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    TransferenciaCrsJpaController transferenciaCrsController = new TransferenciaCrsJpaController(emf);
    ...
    List<TransferenciaCrs> pedidos = transferenciaCrsController.findTransferenciaCrsEntities();
    List<Curso> cursos = cursoController.findCursoEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Transferência para outros CRs</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/tranferencia_cr" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Transferência para outros CRs" readonly="">
                            ...
                            <div class="j-row">
                                <div class="j-span6 j-unit">
                                    <label class="j-label">Origem</label>
                                    <div class="j-input">
                                        <label class="j-icon-right" for="origem">
                                            <i class="icofont icofont-ui-calendar"></i>
                                        </label>
                          <input type="text" id="origem" name="origem" value="Cr Origem" readonly="">

                                    </div>
                                </div>
                                <div class="j-span6 j-unit">
                                    <label class="j-label">Destino</label>
                                    <div class="j-input">
                                        <label class="j-icon-right" for="destino">
                                            <i class="icofont icofont-ui-calendar"></i>
                                        </label>
                                        <select name="destino">
                                            <option>Seleccionar Destino...</option>
                                            <%for (Curso c : cursos) {%>
                                            <option value="<%=c.getId()%>"><%out.print(c.getFaculdade().getSigla());%></option>
                                            <%}%>
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="dt-responsive table-responsive">
            <table id="new-cons" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    <%
                        if (utilizador.getTipoUtilizador().getDescricao().equalsIgnoreCase("administador")) {
                            for (TransferenciaCrs e : pedidos)
