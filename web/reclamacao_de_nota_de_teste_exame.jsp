...
<%@page import="modelo.ReclamacaoNota"%>
<%@page import="controller.ReclamacaoNotaJpaController"%>
...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    ...
    List<ReclamacaoNota> pedidos = cartaoEstudanteController.findReclamacaoNotaEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Reclamação de Nota</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/reclamacao_nota" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Reclamação de Nota de Teste/Exame" readonly="">
