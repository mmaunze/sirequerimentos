<%@page import="modelo.ReintegracaoAcademica"%>
<%@page import="controller.ReintegracaoAcademicaJpaController"%>
...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    ...
    List<ReintegracaoAcademica> pedidos = reintegracaoAcademicaController.findReintegracaoAcademicaEntities();
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Reintegração para o ano Académico 20__</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/reintegracao_academica" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-unit">
                                <label class="j-label">Ano de Reintegração</label>
                                <div class="j-input">
                                    <label class="j-icon-right" for="ano">
                                        <i class="icofont icofont-ui-user"></i>
                                    </label>
                                    <input type="text" id="ano" name="ano" value="2024" >
                                </div>
                            </div>     
                            <!-- end date -->
                            <div class="j-divider j-gap-bottom-25"></div>
        ...
        <div class="dt-responsive table-responsive">
            <table id="new-cons" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    <%
                        if (utilizador.getTipoUtilizador().getDescricao().equalsIgnoreCase("administador")) {
                            for (ReintegracaoAcademica e : pedidos)
