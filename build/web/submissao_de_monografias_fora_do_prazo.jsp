...
<% EntityManagerFactory emf = Persistence.createEntityManagerFactory("SistemaSubmissaoRequereimentosPU");
    ...
    List<SubmissaoMonografias> pedidos = submissaoMonografiasController.findSubmissaoMonografiasEntities() ;
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Submissão de Monografias fora do Prazo</h5>
                <span>Preencha os Dados </span>

            </div>
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    <form action="/sirequerimentos/submissao_de_monografias_fora_do_prazo" method="post" class="j-pro">
                        <div class="j-content">
                            <!-- start name -->
                            <div class="j-unit">
                            ...
                            <div class="j-row">
                                ...
                                <div class="j-span6 j-unit">
                                    ...
                                    <div class="j-input">
                                        ...
                                        <input type="text" id="tipo_pedido" name="tipo_pedido" value="Submissão de Monografias fora do Prazo" readonly="">
        ...
        <div class="dt-responsive table-responsive">
            <table id="new-cons" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    <%
                        if (utilizador.getTipoUtilizador().getDescricao().equalsIgnoreCase("administador")) {
                            for (SubmissaoMonografias e : pedidos)
