(function (i) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (g) { return i(g, window, document) }) : "object" === typeof exports ? module.exports = function (g, k, q, r) { g || (g = window); if (!k || !k.fn.dataTable) k = require("datatables.net")(g, k).$; k.fn.dataTable.Buttons || require("datatables.net-buttons")(g, k); return i(k, g, g.document, q, r) } : i(jQuery, window, document) })(function (i, g, k, q, r, p) {
    function y(a, c) {
        ...
        { match: /^\-?[\d,]+\.\d{2}$/, style: 64 }]; l.ext.buttons.copyHtml5 = {
            className: "buttons-copy buttons-html5", text: function (a) { return a.i18n("buttons.copy", "Copiar") }, action: function (a, c, d, b) {
                var a = F(c, b), e = a.str, d = i("<div/>").css({ height: 1, width: 1, overflow: "hidden", position: "fixed", top: 0, left: 0 }); b.customize && (e = b.customize(e, b)); b = i("<textarea readonly/>").val(e).appendTo(d); if (k.queryCommandSupported("copy")) {
                    d.appendTo(c.table().container()); b[0].focus(); b[0].select(); try {
                        ...
                        if (f) { c.buttons.info(c.i18n("buttons.copyTitle", "Copiado"), c.i18n("buttons.copySuccess", { 1: "Um registo copiado para area de transferencia", _: " %d registos copiados para a area de transferencia" }, a.rows), 2E3); return }
                    } catch (h) { }
            ...
            available: function () { return g.FileReader !== p && (r || g.pdfMake) }, text: function (a) { return a.i18n("buttons.pdf", "Baixar em PDF") }, action: function (a, c, d, b) {
